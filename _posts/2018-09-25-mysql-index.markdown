...
![预览图](http://blog.jinwork.vip/img/blog/7d6b1a54-61dd-4ecb-9b84-b064ec95775a.png)<!--more-->
...
![](http://blog.jinwork.vip/img/blog/0C246BB99D16D11FDF529437864AB7CE.png)
...
![](http://blog.jinwork.vip/img/blog/A9F238357681376D30DF3C6F524156FB.png)
...
![](http://blog.jinwork.vip/img/blog/C6D5AF9F2923AFB70753E9B9556FE42A.png)
...
![](http://blog.jinwork.vip/img/blog/1592A1D1B6F59FDEC422FF5FC1C97CC0.png)
...
![](http://blog.jinwork.vip/img/blog/63B428EC932670CB74B3A1B6249407AA.png)
...
![](http://blog.jinwork.vip/img/blog/843424197A8FFFCD2894AC9B2F13302F.png)

一个磁盘由大小相同且同轴的圆形盘片组成，磁盘可以转动（各个磁盘必须同步转动）。在磁盘的一侧有磁头支架，磁头支架固定了一组磁头，每个磁头负责存取一个磁盘的内容。磁头不能转动，但是可以沿磁盘半径方向运动（实际是斜切向运动），每个磁头同一时刻也必须是同轴的，即从正上方向下看，所有磁头任何时候都是重叠的（不过目前已经有多磁头独立技术，可不受此限制）。

图 7 是磁盘结构的示意图。

![](http://blog.jinwork.vip/img/blog/D13A43EAC5F0ECEE1FE1DA0AA06F69B4.png)
...
![](http://blog.jinwork.vip/img/blog/53542FB1F6F6B898BEE53F4AE356564A.png)
...
![](http://blog.jinwork.vip/img/blog/3A4B107A96CE4C008B15D740D19CAF98.png)
...
![](http://blog.jinwork.vip/img/blog/6D0B18886D8A8FB14E512CEEE869B07B.png)
...
![](http://blog.jinwork.vip/img/blog/09D4DC9D97CBE8A634D244232710688E.png)
...
![](http://blog.jinwork.vip/img/blog/A561801D4FD4EAFB9FB7FB538ED8081F.png)
...
![](http://blog.jinwork.vip/img/blog/48E546C2BE936C4A7CA2BB19FE4AA6DE.png)

这样就会形成一个紧凑的索引结构，近似顺序填满。由于每次插入时也不需要移动已有数据，因此效率很高，也不会增加很多开销在维护索引上。

如果使用非自增主键（如果身份证号或学号等），由于每次插入主键的值近似于随机，因此每次新纪录都要被插到现有索引页得中间某个位置：

![](http://blog.jinwork.vip/img/blog/249AA6DD62821BDAC73892DEA1F61C4B.png)
